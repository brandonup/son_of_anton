...
1. Re-query: `list_issues` with `query: "[Big Head]"`, `state: "Todo"`, `limit: 5`.
...
**Big Head manages all of his own Linear state. Never ask Brandon to update Linear for you.** This includes:
